...
rm -f ranking.pkl $1.internal_background_tchunk_list $1.internal_foreground_tchunk_list $1.out_term_list $1.all_terms background_tchunk_list foreground_tchunk_list
rm -rf $1_tagged output_foreground output_background 
